...
const NAV_PAGES: &[Page] = &[
    Page::Home, Page::About, Page::Highscore,
];
                    ...
                    main {
                        ...
                        footer {
                            p style="margin: 0.2rem 0 0.2rem 0" {
                                "This site was created without the use of generative AI. ~ Opinions are those of your pet hamster."
                                br;
                                br;
